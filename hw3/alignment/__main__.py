...
if args.F == True: # batch analysis
    ...
    opt_matrix,changes = optimize(new_score_matrix,pos_alignments,neg_alignments,best_cutoff=10,
                            step_frac=0.2,total_iterations=10,merge_iterations=2)

    write_matrix('optimized_matrix',opt_matrix,changes=changes,
                         base_matrix_name='BLOSUM50 -4/1')
    print("global iterations 5, merge iterations 2, cutoff 5, scale factor 0.2")
    #print(opt_matrix)
    #print()
    #print(changes)
